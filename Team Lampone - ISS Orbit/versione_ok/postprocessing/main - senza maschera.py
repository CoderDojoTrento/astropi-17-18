...
FOLDER_IMMAGINI = "3475_Team Lampone" # "enviro-pi" # "file_esempio"
...
SALVA_IMMAGINI_INCOLLATE = True
SALVA_IMMAGINI_PUNTI_CHIAVE = True
...
resx=1944#640     # risoluzione img x (v1: 2592 x 1944 pixels; v2: 3280 x 2464 pixels)
...
DIMENSIONE_RIDOTTA = 2592 #800 # misura massima in pixel (per ridurre il tempo di elaborazione)
