...
for file_immagine in lista_imgs[:]:
    ...
    ## diametro vista oblo': 400 Km => 400 Km su mappa larga 1920 = 40.000 Km sono 400/40000*1920 = 19.2 = ca 20 diametro => 10 raggio
    circle = Circle(xy=map(degrees(ISS.sublong),degrees(ISS.sublat)),radius=400000/2, fill=False)
